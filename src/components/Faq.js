  ...
  rows: [
    {
      ...
      content: `To search the certificate online go to VRC official website
      `,
    },
    {
      title:
    ...
    },
    {
      ...
      content: `It can be avail from the City Civic Centre run by ARC. From the available Gujarati
    ...
    },
    {
      ...
      Favor of "Rathod CommissionerAhmedabad" payable at Ahmedabad or
      ONLINE Payment.`,
    },
  ],
  title: 'FAQs rathod corporation',
  rows: [
    {
      title: 'How to search Death Birth certificate online ?',
      content: `To search the certificate online go to VRC official website
